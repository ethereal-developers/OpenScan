...
vector<Point> getPoints(Mat image)
{
    ...
    GaussianBlur(image_proc, blurred, Size(5, 5), 0);
...
JNIEXPORT jobject JNICALL Java_com_scanlibrary_ScanActivity_getScannedBitmap(JNIEnv *env, jobject thiz, jobject bitmap, jfloat x1, jfloat y1, jfloat x2, jfloat y2, jfloat x3, jfloat y3, jfloat x4, jfloat y4)
{
...
JNIEXPORT jobject JNICALL Java_com_scanlibrary_ScanActivity_getMagicColorBitmap(JNIEnv *env, jobject thiz, jobject bitmap)
{
...
JNIEXPORT jobject JNICALL Java_com_scanlibrary_ScanActivity_getBWBitmap(JNIEnv *env, jobject thiz, jobject bitmap)
{
...
JNIEXPORT jobject JNICALL Java_com_scanlibrary_ScanActivity_getGrayBitmap(JNIEnv *env, jobject thiz, jobject bitmap)
{
...
JNIEXPORT jfloatArray JNICALL Java_com_scanlibrary_ScanActivity_getPoints(JNIEnv *env, jobject thiz, jobject bitmap)
{
