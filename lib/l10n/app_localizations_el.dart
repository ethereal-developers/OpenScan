...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get app_description =>
      'είναι μια εφαρμογή ανοικτού κώδικα για τη σάρωση εγγράφων και τη μετατροπή τους σε PDF.';
  ...
  @override
  String get tutorial_title => 'Πώς χρησιμοποιείται η εφαρμογή;';

  @override
  String get done => 'Ολοκληρώθηκε';

  @override
  String get skip => 'Παράληψη';
